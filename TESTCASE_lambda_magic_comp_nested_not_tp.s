...
push rax
push 1
;(LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [Var' ( VarParam ( y , 1 ))] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
jne is_not_empty_390
MALLOC rdx, 8
mov qword[rdx], SOB_NIL_ADDRESS
jmp is_empty_391
is_not_empty_390:
...
shr rcx, 3
cmp rcx, 0
je no_more_params_394
params_loop_393:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi*8], rsi
loop params_loop_393
no_more_params_394:
mov qword[rdx], rbx
is_empty_391:
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_395)
jmp Lcont_396
Lcode_395:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
...
push rax
push 1
;(LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [Var' ( VarParam ( y , 1 ))] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
jne is_not_empty_415
MALLOC rdx, 8
mov qword[rdx], SOB_NIL_ADDRESS
jmp is_empty_416
is_not_empty_415:
...
shr rcx, 3
cmp rcx, 0
je no_more_params_419
params_loop_418:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi*8], rsi
loop params_loop_418
no_more_params_419:
mov qword[rdx], rbx
is_empty_416:
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_420)
jmp Lcont_421
Lcode_420:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
...
push rax
push 1
;(LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [Var' ( VarParam ( y , 1 ))] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
jne is_not_empty_440
MALLOC rdx, 8
mov qword[rdx], SOB_NIL_ADDRESS
jmp is_empty_441
is_not_empty_440:
...
shr rcx, 3
cmp rcx, 0
je no_more_params_444
params_loop_443:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi*8], rsi
loop params_loop_443
no_more_params_444:
mov qword[rdx], rbx
is_empty_441:
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_445)
jmp Lcont_446
Lcode_445:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
...
push rax
push 1
;(LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [Var' ( VarParam ( y , 1 ))] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
jne is_not_empty_465
MALLOC rdx, 8
mov qword[rdx], SOB_NIL_ADDRESS
jmp is_empty_466
is_not_empty_465:
...
shr rcx, 3
cmp rcx, 0
je no_more_params_469
params_loop_468:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi*8], rsi
loop params_loop_468
no_more_params_469:
mov qword[rdx], rbx
is_empty_466:
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_470)
jmp Lcont_471
Lcode_470:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
...
push rax
push 1
;(LambdaOpt'(  ( x . y ), , [(Seq'( [Applic'( (LambdaOpt'(  ( x . y ), , [Var' ( VarParam ( y , 1 ))] ) , [Const' ( 1)] ) , Var' ( VarParam ( y , 1 ))] )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
jne is_not_empty_490
MALLOC rdx, 8
mov qword[rdx], SOB_NIL_ADDRESS
jmp is_empty_491
is_not_empty_490:
...
shr rcx, 3
cmp rcx, 0
je no_more_params_494
params_loop_493:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi*8], rsi
loop params_loop_493
no_more_params_494:
mov qword[rdx], rbx
is_empty_491:
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_495)
jmp Lcont_496
Lcode_495:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
...
push rax
push 1
;(LambdaOpt'(  ( x . y ), , [Var' ( VarParam ( y , 1 ))] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
jne is_not_empty_515
MALLOC rdx, 8
mov qword[rdx], SOB_NIL_ADDRESS
jmp is_empty_516
is_not_empty_515:
...
shr rcx, 3
cmp rcx, 0
je no_more_params_519
params_loop_518:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi*8], rsi
loop params_loop_518
no_more_params_519:
mov qword[rdx], rbx
is_empty_516:
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_520)
jmp Lcont_521
Lcode_520:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
