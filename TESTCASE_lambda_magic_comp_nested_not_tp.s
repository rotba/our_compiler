...
shr rcx, 3
cmp rcx, 0
je no_more_params_115
params_loop_114:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi], rsi
loop params_loop_114
no_more_params_115:
is_empty_112:
mov qword[rdx], rbx
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_116)
jmp Lcont_117
Lcode_116:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
...
shr rcx, 3
cmp rcx, 0
je no_more_params_140
params_loop_139:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi], rsi
loop params_loop_139
no_more_params_140:
is_empty_137:
mov qword[rdx], rbx
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_141)
jmp Lcont_142
Lcode_141:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
