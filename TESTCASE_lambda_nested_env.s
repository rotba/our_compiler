...
push rax
push 2
;(LambdaSimple'(  ( a , b ) , [(Seq'( [Applic'( (LambdaSimple'(  ( c , d , e ) , [Var' ( VarParam ( e , 2 ))] ) , [Const' ( 1) , Const' ( 2) , Const' ( 3)] ) , Var' ( VarParam ( a , 0 ))] )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
...
push rax
push 3
;(LambdaSimple'(  ( c , d , e ) , [Var' ( VarParam ( e , 2 ))] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
jne is_not_empty_427
MALLOC rdx, 8
mov qword[rdx], SOB_NIL_ADDRESS
jmp is_empty_428
is_not_empty_427:
...
shr rcx, 3
cmp rcx, 0
je no_more_params_431
params_loop_430:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi*8], rsi
loop params_loop_430
no_more_params_431:
mov qword[rdx], rbx
is_empty_428:
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_432)
jmp Lcont_433
Lcode_432:
push rbp
mov rbp, rsp
