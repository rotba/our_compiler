...
shr rcx, 3
cmp rcx, 0
je no_more_params_3550
params_loop_3549:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi], rsi
loop params_loop_3549
no_more_params_3550:
is_empty_3547:
mov qword[rdx], rbx
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_3551)
jmp Lcont_3552
Lcode_3551:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
mov rcx, qword[rsp+ 8*2]; rcx is m
cmp rcx, 1
jne not_empty_opt_3553
; m = n
add rcx, 3;m+2 - offset of magic
shl rcx, 3
mov qword[rsp+rcx], SOB_NIL_ADDRESS; magic is NIL
jmp done_fixing_3554
not_empty_opt_3553:
add rcx, 2; rcx is m+2 - the offset of the ultimetly last argument
mov rdi, rcx
mov rbx, qword[rsp+8*rdi]
...
shr rcx, 3
cmp rcx, 0
je no_more_params_3570
params_loop_3569:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi], rsi
loop params_loop_3569
no_more_params_3570:
is_empty_3567:
mov qword[rdx], rbx
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_3571)
jmp Lcont_3572
Lcode_3571:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
mov rcx, qword[rsp+ 8*2]; rcx is m
cmp rcx, 1
jne not_empty_opt_3573
; m = n
add rcx, 3;m+2 - offset of magic
shl rcx, 3
mov qword[rsp+rcx], SOB_NIL_ADDRESS; magic is NIL
jmp done_fixing_3574
not_empty_opt_3573:
add rcx, 2; rcx is m+2 - the offset of the ultimetly last argument
mov rdi, rcx
mov rbx, qword[rsp+8*rdi]
...
mov rcx, qword[rsp+ 8*2]; rcx is m
cmp rcx, 1
jne not_empty_opt_3593
; m = n
add rcx, 3;m+2 - offset of magic
shl rcx, 3
mov qword[rsp+rcx], SOB_NIL_ADDRESS; magic is NIL
jmp done_fixing_3594
not_empty_opt_3593:
add rcx, 2; rcx is m+2 - the offset of the ultimetly last argument
mov rdi, rcx
mov rbx, qword[rsp+8*rdi]
...
shr rcx, 3
cmp rcx, 0
je no_more_params_3610
params_loop_3609:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi], rsi
loop params_loop_3609
no_more_params_3610:
is_empty_3607:
mov qword[rdx], rbx
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_3611)
jmp Lcont_3612
Lcode_3611:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
mov rcx, qword[rsp+ 8*2]; rcx is m
cmp rcx, 1
jne not_empty_opt_3613
; m = n
add rcx, 3;m+2 - offset of magic
shl rcx, 3
mov qword[rsp+rcx], SOB_NIL_ADDRESS; magic is NIL
jmp done_fixing_3614
not_empty_opt_3613:
add rcx, 2; rcx is m+2 - the offset of the ultimetly last argument
mov rdi, rcx
mov rbx, qword[rsp+8*rdi]
