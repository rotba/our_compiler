...
push rax
push 1
;(LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [Var' ( VarParam ( y , 1 ))] ) , [Const' ( 1)] )] ) , [Const' ( 1)] )] ) , [Const' ( 1)] )] ) , [Const' ( 1)] )] ) , [Const' ( 1)] )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
...
push rax
push 1
;(LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [Var' ( VarParam ( y , 1 ))] ) , [Const' ( 1)] )] ) , [Const' ( 1)] )] ) , [Const' ( 1)] )] ) , [Const' ( 1)] )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
jne is_not_empty_410
MALLOC rdx, 8
mov qword[rdx], SOB_NIL_ADDRESS
jmp is_empty_411
is_not_empty_410:
...
shr rcx, 3
cmp rcx, 0
je no_more_params_414
params_loop_413:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi*8], rsi
loop params_loop_413
no_more_params_414:
mov qword[rdx], rbx
is_empty_411:
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_415)
jmp Lcont_416
Lcode_415:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
...
push rax
push 1
;(LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [Var' ( VarParam ( y , 1 ))] ) , [Const' ( 1)] )] ) , [Const' ( 1)] )] ) , [Const' ( 1)] )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
jne is_not_empty_430
MALLOC rdx, 8
mov qword[rdx], SOB_NIL_ADDRESS
jmp is_empty_431
is_not_empty_430:
...
shr rcx, 3
cmp rcx, 0
je no_more_params_434
params_loop_433:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi*8], rsi
loop params_loop_433
no_more_params_434:
mov qword[rdx], rbx
is_empty_431:
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_435)
jmp Lcont_436
Lcode_435:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
...
push rax
push 1
;(LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [Var' ( VarParam ( y , 1 ))] ) , [Const' ( 1)] )] ) , [Const' ( 1)] )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
jne is_not_empty_450
MALLOC rdx, 8
mov qword[rdx], SOB_NIL_ADDRESS
jmp is_empty_451
is_not_empty_450:
...
shr rcx, 3
cmp rcx, 0
je no_more_params_454
params_loop_453:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi*8], rsi
loop params_loop_453
no_more_params_454:
mov qword[rdx], rbx
is_empty_451:
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_455)
jmp Lcont_456
Lcode_455:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
...
push rax
push 1
;(LambdaOpt'(  ( x . y ), , [ApplicTP'( (LambdaOpt'(  ( x . y ), , [Var' ( VarParam ( y , 1 ))] ) , [Const' ( 1)] )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
jne is_not_empty_470
MALLOC rdx, 8
mov qword[rdx], SOB_NIL_ADDRESS
jmp is_empty_471
is_not_empty_470:
...
shr rcx, 3
cmp rcx, 0
je no_more_params_474
params_loop_473:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi*8], rsi
loop params_loop_473
no_more_params_474:
mov qword[rdx], rbx
is_empty_471:
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_475)
jmp Lcont_476
Lcode_475:
;donte the effective numer of parameters m
;donte the noumber of simple parameters n
