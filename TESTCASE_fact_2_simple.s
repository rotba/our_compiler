...
push 0
;(LambdaSimple'(  (  ) , [ApplicTP'( Var' ( VarFree ( * )) , [Const' ( 1) , Applic'( (LambdaSimple'(  (  ) , [(If'( Applic'( Var' ( VarFree ( = )) , [Const' ( 0) , Const' ( 0)] ) , Const' ( 1),Const' ( 496351) )] ) , [] )] )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
...
push 0
;(LambdaSimple'(  (  ) , [(If'( Applic'( Var' ( VarFree ( = )) , [Const' ( 0) , Const' ( 0)] ) , Const' ( 1),Const' ( 496351) )] )
GET_ENV rbx
mov rcx, 0
cmp rbx, SOB_NIL_ADDRESS
jne is_not_empty_3571
MALLOC rdx, 8
mov qword[rdx], SOB_NIL_ADDRESS
jmp is_empty_3572
is_not_empty_3571:
...
shr rcx, 3
cmp rcx, 0
je no_more_params_3575
params_loop_3574:
mov rdi, rcx
dec rdi;rdi is the 0 based index of the current arg
GET_ARG rsi, rdi
mov qword[rbx + rdi*8], rsi
loop params_loop_3574
no_more_params_3575:
mov qword[rdx], rbx
is_empty_3572:
;;RDX IS THE EXTENV!!!
MAKE_CLOSURE(rax, rdx, Lcode_3576)
jmp Lcont_3577
Lcode_3576:
push rbp
mov rbp, rsp
